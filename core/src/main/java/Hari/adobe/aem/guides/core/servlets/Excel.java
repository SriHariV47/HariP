...
@Component(service = Servlet.class, property = { "sling.servlet.paths=/bin/uploadexcel" })
public class Excel extends SlingAllMethodsServlet {
    ...
    public void addproperties(List<String> multiFieldslist ,Map<String, String> propertiesMap, SlingHttpServletRequest request, SlingHttpServletResponse response) throws IOException {
         ...
         try {
             ...
             String path = "/content/dam/Hari/PORTAL_SCHEMA2.xlsx/jcr:content/metadata";
