 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.Hari.components.spa.software;
                                                    ...
                                                    if (var_notempty16) {
                                                        {
                                                            long var_end19 = var_size15;
                                                            {
                                                                ...
                                                                if (var_validstartstepend20) {
                                                                    ...
                                                                    long var_index21 = 0;
                                                                    for (Object item_1 : var_collectionvar14_list_coerced$) {
                                                                        {
                                                                            boolean var_traversal23 = (((var_index21 >= 0) && (var_index21 <= var_end19)) && true);
                                                                            if (var_traversal23) {
                                                                                out.write("\n<div>");
                                                                                {
                                                                                    String var_24 = ("Name:" + renderContext.getObjectModel().toString(renderContext.call("xss", renderContext.getObjectModel().resolveProperty(item_1, "name"), "text")));
                                                                                    out.write(renderContext.getObjectModel().toString(var_24));
                                                                                }
                                                                                out.write("</div>\n<div>");
                                                                                {
                                                                                    String var_25 = (("SecondLevelEnabled:" + renderContext.getObjectModel().toString(renderContext.call("xss", renderContext.getObjectModel().resolveProperty(item_1, "secondLevelEnabled"), "text"))) + " ");
                                                                                    out.write(renderContext.getObjectModel().toString(var_25));
                                                                                }
                                                                                out.write("</div>\n<div>SelectedIcon:<img");
                                                                                {
                                                                                    Object var_attrvalue26 = renderContext.getObjectModel().resolveProperty(item_1, "selectedIcon");
                                                                                    {
                                                                                ...
                                                                                out.write("/> </div>\n<div>");
                                                                                {
                                                                                    String var_30 = ("MainAnchorDisabled:" + renderContext.getObjectModel().toString(renderContext.call("xss", renderContext.getObjectModel().resolveProperty(item_1, "mainAnchorDisabled"), "text")));
                                                                                    out.write(renderContext.getObjectModel().toString(var_30));
                                                                                }
                                                                                out.write("</div>\n<div>");
                                                                                {
                                                                                    String var_31 = ("Target:" + renderContext.getObjectModel().toString(renderContext.call("xss", renderContext.getObjectModel().resolveProperty(item_1, "target"), "text")));
                                                                                    out.write(renderContext.getObjectModel().toString(var_31));
                                                                                }
                                                                                out.write("</div>\n<div>Icon:<img");
                                                                                {
                                                                                    Object var_attrvalue32 = renderContext.getObjectModel().resolveProperty(item_1, "icon");
                                                                                    {
                                                                                ...
                                                                                out.write("/> </div>\n<div>");
                                                                                {
                                                                                    String var_36 = (("Path:" + renderContext.getObjectModel().toString(renderContext.call("xss", renderContext.getObjectModel().resolveProperty(item_1, "path"), "text"))) + " ");
                                                                                    out.write(renderContext.getObjectModel().toString(var_36));
                                                                                }
                                                                                out.write("</div>\n\n");
                                                                                {
                                                                                    Object var_collectionvar37 = renderContext.getObjectModel().resolveProperty(item_1, "secondlevelsidebarmanual");
                                                                                    {
                                                    ...
                                                    if (var_notempty50) {
                                                        {
                                                            long var_end53 = var_size49;
                                                            {
                                                                ...
                                                                if (var_validstartstepend54) {
                                                                    ...
                                                                    long var_index55 = 0;
                                                                    for (Object item_1 : var_collectionvar48_list_coerced$) {
                                                                        {
                                                                            boolean var_traversal57 = (((var_index55 >= 0) && (var_index55 <= var_end53)) && true);
                                                                            if (var_traversal57) {
                                                                                out.write("\n<div>");
                                                                                {
                                                                                    String var_58 = ("Section Name:" + renderContext.getObjectModel().toString(renderContext.call("xss", renderContext.getObjectModel().resolveProperty(item_1, "sectionName"), "text")));
                                                                                    out.write(renderContext.getObjectModel().toString(var_58));
                                                                                }
                                                                                out.write("</div>\n\n");
                                                                                {
                                                                                    Object var_collectionvar59 = renderContext.getObjectModel().resolveProperty(item_1, "items");
                                                                                    {
