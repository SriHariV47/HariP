 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.Hari.components.json;
...
public final class json_html extends RenderUnit {
...
out.write("hello \n<!-- File: JsonOsgiConfigModel.html -->\n\n");
_global_model = renderContext.call("use", "Hari.adobe.aem.guides.core.models.JsonOsgiConfigModel", obj());
out.write("\n\n<h2>User Details:</h2>\n<ul>\n    <li>");
{
